...
module.exports = function (app) {
  ...
  // Tambah atau update subdomain Cloudflare
  app.get('/cloudflare/add-subdomain', async (req, res) => {
    const { subdomain, content, zoneid, token, domain } = req.query;
    ...
    // Type dan proxied otomatis
    const recordType = "A";   // selalu A
    const proxyStatus = true; // selalu true
